...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2024 at 11:28 AM
...
(7, 'Always Punctual'),
(8, 'Is Hardworking'),
(9, 'Maintains Camaraderie among Workmates'),
(10, 'Follows rules well');
...
(18, 104, 2, '2024-11-17', 'Evaluation is Finished', 'Submitted');
...
--
ALTER TABLE `evaluation_scores`
  MODIFY `score_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `time_in`
--
ALTER TABLE `time_in`
  MODIFY `timelogs_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `time_out`
  MODIFY `timelogs_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
