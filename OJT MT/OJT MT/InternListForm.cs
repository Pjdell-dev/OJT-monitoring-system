...
namespace OJT_MT
{
    public partial class InternListForm : Form
    {
        ...
        private void printEvalDocument_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
            {
                ...
                Image pfPic = Properties.Resources.icon_default;
        ...
        private void printEvalDocument_EndPrint(object sender, PrintEventArgs e)
        {
            ClearItems(); // Safely clear data after printing
        }
