        ...
        private async Task LoadStudentInfo(int studentNumber)
        {
            try
            {
                ...
                if (await reader.ReadAsync())
                {
                    ...
                    baseString = reader["pfPic"].ToString();
                }
            }
            catch (Exception ex)
            {
        ...
        private void printEvalDocument_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
            {
                ...
                Image pfPic = Base64toImage(baseString);
            ...
            if (criteriaNames.Count == EvalScores.Count) // Ensure both collections have the same count
            {
                ...
                e.Graphics.DrawString("Average:", fontRegular, Brushes.Black, tableX, y + 120);
                e.Graphics.DrawString(average.ToString(), fontRegular, Brushes.Black, tableX + 90, y + 120);
            }
            else
            {
            ...
            e.Graphics.DrawString("Comments:", fontRegular, Brushes.Black, tableX, y + 150);
            e.Graphics.DrawString(labelEvalComments.ToString(), fontRegular, Brushes.Black, tableX, y + 150 + rowHeight);
