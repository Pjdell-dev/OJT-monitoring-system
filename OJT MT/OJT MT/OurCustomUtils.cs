...
namespace OJT_MT
{
    public static class OurCustomUtils
    {
        ...
        public static string PassHash(string rawData)
        {
        ...
        public static byte[] ImageToLongBlob(System.Drawing.Image image)
        {
        ...
        public static System.Drawing.Image LongBlobToImage(byte[] longBlob)
        {
            try
            {
                using (MemoryStream ms = new MemoryStream(longBlob))
                {
